...
function img_filt = log_filter_3D( img, sigma, filter_size)
...
try
    ...
    I_3 = imfilter( imfilter( imfilter( img, h_b_x,'same','replicate'), h_b_y,'same','replicate'),h_f_z,'same','replicate');    
