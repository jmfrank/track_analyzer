%Pass a 2D frame and find spots. Uses 'region_props' data to make fits. 

function fit = fit_this_frame_centroid_2D( img, stats, params )
...
for i = 1:size(centers,1)
    ...
    [Y,X] = ind2sub(size(search_stack),fg_ind);
