...
% Now just a single script for 2D and 3D. 
...
function obj = segment(obj, FORCE_ALL_FRAMES, debug)
...
%%%%%%%%%%%%%%% START PROCESSING %%%%%%%%%%%%%%%%
    ...
    disp( ['Segment dimension: ',num2str(exp_info.params.(CHANNEL_name).cells.seg_dims)] )
